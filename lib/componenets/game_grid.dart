              ...
              GestureDetector(
                onTap: () {
                  ...
                  if(visitedCells.contains(index)) {
                    ...
                    visitedCells.insert(visitedCells.length, index.toInt());
                    isCellClicked.insert(isCellClicked.length, index.toInt());
                    _fillOptionsList(index);
                  } //else
                }
            ),
              if (isCellClicked.contains(index))
                const Center(
                  child: Icon(
                    Icons.close,
                    color: Colors.red,
